        ...
        <main className="container mx-auto px-4 py-6">
          ...
          <div className="bg-white rounded-lg shadow-sm border p-4">
            ...
            <div className="w-full relative">
              ...
              <div className="absolute top-[33px] left-16 text-xs text-gray-700">
              ...
              <div className="absolute bottom-[79px] right-8 bg-white bg-opacity-90 px-2 py-1 rounded text-xs">
