...
export default function Footer() {
  return (
    <footer className="w-full flex justify-center">
      <div className="max-w-md w-full bg-yellow-400 text-gray-800 px-4 py-6">
        {/* Fale Conosco Section */}
        <div className="mb-8">
          <h3 className="text-xl font-bold mb-4 text-gray-900">Fale Conosco</h3>
        ...
        <div className="mb-8">
          <h3 className="text-xl font-bold mb-4 text-gray-900">Sobre os Correios</h3>
          <div className="space-y-3">
            <button className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors">
        ...
        <div>
          <h3 className="text-xl font-bold mb-4 text-gray-900">Outros Sites</h3>
          <div className="space-y-3">
            <button className="flex items-center space-x-3 text-blue-600 hover:text-blue-700 transition-colors">
